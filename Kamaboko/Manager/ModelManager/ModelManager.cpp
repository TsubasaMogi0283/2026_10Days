...
uint32_t Kamaboko::ModelManager::LoadModelFileForLevelData(const std::string& directoryPath, const std::string& fileName) {
	...
	if (Kamaboko::ModelManager::GetInstance()->modelInfromtion_.find(filePath) != Kamaboko::ModelManager::GetInstance()->modelInfromtion_.end()) {
		return Kamaboko::ModelManager::GetInstance()->modelInfromtion_[filePath].handle;
	}
	...
	//登録
	Kamaboko::ModelManager::GetInstance()->modelInfromtion_[filePath] = modelInformation;
...
uint32_t Kamaboko::ModelManager::Load(const std::string& directoryPath, const std::string& fileName) {
	...
	//モデルの読み込み
	ModelData newModelData = Kamaboko::ModelManager::GetInstance()->LoadFile(directoryPath, fileName);
	//ハンドル
	uint32_t handle = modelhandle;
	//パス
	std::string path = directoryPath;
...
uint32_t Kamaboko::ModelManager::Load(const std::string& directoryPath, const std::string& fileName, const bool& isAnimationLoad) {
	...
	if (Kamaboko::ModelManager::GetInstance()->modelInfromtion_.find(filePath) != ModelManager::GetInstance()->modelInfromtion_.end()) {
		return Kamaboko::ModelManager::GetInstance()->modelInfromtion_[filePath].handle;
	}
