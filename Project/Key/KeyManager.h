...
private:
	...
	//UI
	std::unique_ptr<Kamaboko::Sprite> keyListSprite_ = nullptr;
	//鍵
	std::array<std::unique_ptr<Kamaboko::Sprite>, MAX_KEY_QUANTITY_> keySprites_ = { nullptr };
	//サイズ
	...
	//鍵取得するかどうか
	std::unique_ptr<Kamaboko::Sprite> pickUpKey_ = nullptr;
	//プレイヤーと全ての鍵の距離
