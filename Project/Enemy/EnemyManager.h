...
public:
	...
	inline void SetLevelDataManager(Kamaboko::LevelDataManager* levelDataManager,const uint32_t& levelDataHandle) {
...
private:
	...
	//警告
	std::unique_ptr<Kamaboko::Sprite>warningSprite_ = nullptr;
	//座標
