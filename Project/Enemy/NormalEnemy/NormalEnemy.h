...
private:
	//アニメーションモデル
	std::unique_ptr<Kamaboko::AnimationModel>animationmodel_ = nullptr;
	...
	//パーティクル
	std::unique_ptr<Kamaboko::Particle3D> deadParticle_ = {};
	//感電
	std::unique_ptr<Kamaboko::Particle3D> electricShockParticle_ = {};
