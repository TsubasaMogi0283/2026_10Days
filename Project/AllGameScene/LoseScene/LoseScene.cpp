...
void LoseScene::Initialize(){
	...
	//ディゾルブ
	dissolveEffect_ = std::make_unique<Kamaboko::DissolvePostEffect>();
	dissolveEffect_->Initialize(CLEAR_COLOR);
	//マスクテクスチャ
	uint32_t maskTexture = Kamaboko::TextureManager::GetInstance()->Load("Resources/External/Texture/Dissolve/noise0.png");
...
void LoseScene::Update(Kamaboko::GameManager* gameManager){
