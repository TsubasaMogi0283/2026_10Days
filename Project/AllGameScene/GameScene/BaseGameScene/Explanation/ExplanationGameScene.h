...
private:
	...
	//説明スプライト
	std::array<std::unique_ptr<Kamaboko::Sprite>, EXPLANATION_QUANTITY_> explanation_ = { nullptr };

	//Spaceで次に進むテキスト
	std::array<std::unique_ptr<Kamaboko::Sprite>, EXPLANATION_QUANTITY_> spaceToNext_ = { nullptr };
