...
private:
	...
	//コリジョン管理
	std::unique_ptr<Kamaboko::CollisionManager> collisionManager_ = nullptr;

	//白フェードのスプライト
	std::unique_ptr<Kamaboko::Sprite> whiteFadeSprite_ = nullptr;
	//黒フェードのスプライト
	std::unique_ptr<Kamaboko::Sprite> blackFadeSprite_ = nullptr;
	//操作のスプライト
	std::unique_ptr<Kamaboko::Sprite> operationSprite_ = nullptr;
	...
	//脱出テキストのスプライト
	std::unique_ptr<Kamaboko::Sprite> escapeTextSprite_ = nullptr;
	//脱出のスプライト
	std::unique_ptr<Kamaboko::Sprite> toEscapeSprite_ = nullptr;
	//アシストの矢印
