...
void WaitingTitleScene::Initialize(){
	...
	//スプライトの生成
	//テキスト
	textSprite_.reset(Kamaboko::Sprite::Create(textTextureHandle, SPRITE_INITIAL_POSITION_));
	//ロゴ
	logoSprite_.reset(Kamaboko::Sprite::Create(logoTextureHandle, SPRITE_INITIAL_POSITION_));
